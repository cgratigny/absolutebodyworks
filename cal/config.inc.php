 ...
 * use one array called SESSION to store our persistent variables.   */
 session_save_path("/home/users/web/b1396/sl.absolutebodyworks/phpsessions");
session_start();
...
if (isset($user['user_lang']) && file_exists($CONFIG['FS_PATH']."lang/{$user['user_lang']}.php") ) {
	require_once $CONFIG['FS_PATH']."lang/{$user['user_lang']}.php";
} elseif (file_exists($CONFIG['FS_PATH']."lang/{$CONFIG['lang']}.php")) {
